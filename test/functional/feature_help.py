...
"""Verify that starting redebalocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start redebalocoin with -h for help text")
        ...
        self.log.info("Start redebalocoin with -version for version information")
        ...
        self.log.info("Start redebalocoind with -fakearg to make sure it does not start")
