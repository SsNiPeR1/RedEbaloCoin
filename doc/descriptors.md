# Support for Output Descriptors in Redebalocoin Core

Since Redebalocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Redebalocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Redebalocoin Core wallets, a convenience function `combo` is
