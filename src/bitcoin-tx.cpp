...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " redebalocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  redebalocoin-tx [options] <hex-tx> [commands]  Update hex-encoded redebalocoin transaction\n" +
            "or:     redebalocoin-tx [options] -create [commands]   Create hex-encoded redebalocoin transaction\n" +
            "\n";
